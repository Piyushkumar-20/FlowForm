...
export const updateFieldInput = z.object({
  ...
  label: z.string().max(100).describe("Update Label of the form").optional(),
  type: formFieldEnum.describe("Update Enums of the fields").optional(),
  ...
  isRequired: z.boolean().default(false).describe("update required text").optional(),
});
